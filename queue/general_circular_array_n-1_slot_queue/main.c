...
void test_int_queue() {
    ...
    assert(isQueueFull(intQueue) == true);  // only 5-1 slots are available
...
void test_char_queue() {
    ...
    assert(isQueueFull(charQueue) == true);  // only 5-1 slots are available
...
void test_string_queue() {
    ...
    assert(isQueueFull(stringQueue) == true);  // only 5-1 slots are available
...
void test_listnode_queue() {
    ...
    assert(isQueueFull(listNodeQueue) == true);  // only 5-1 slots are available
